Project: Multi-Cohort Target Prioritization Pipeline
This repository contains a 4-step computational framework developed to identify and prioritize therapeutic targets from large-scale transcriptomic data (TCGA).
Workflow Highlights:
Infrastructure Adaptation: Custom refactoring of data merging functions to align with modern GDC portal schemas.
